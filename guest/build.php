...
<!-- Bootstrap JS Bundle (for modals, navbar toggling, etc.) -->
 
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.5/dist/js/bootstrap.bundle.min.js"></script>

<!-- Your own JavaScript file (optional: only if you have one) -->
<script src="../main/profile.js"></script>

<!-- Optional: JavaScript that handles component selection and updates the chart -->
<script>
function updateSelection(componentType) {
  ...
  updateRadarChart(); // Update radar chart based on selected components
}
